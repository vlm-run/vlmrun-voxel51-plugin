...
- **Save Generated Images** - When enabled, any images generated by the model
  (e.g., extracted video frames, visualizations) are automatically saved and
  added as new samples to your dataset with the `vlmrun_generated` tag

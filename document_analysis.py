"""
Document Analysis Operator

Analyze document structure and extract text using VLM Run.
"""
...
class DocumentAnalysisOperator(foo.Operator):
    """Operator for analyzing document structure using VLM Run."""
    
    @property
    def config(self):
        return foo.OperatorConfig(
            name="document_analysis",
            label="VLM Run: Document Analysis",
            dynamic=True,
        )
    ...
    def resolve_input(self, ctx):
        ...
        inputs.bool(
            ...
            description="Include bounding box coordinates for text regions",
            default=True,
        )
        ...
        inputs.str(
            ...
            description="Field name to store document analysis results",
            default="vlmrun_document",
        )
    ...
    def execute(self, ctx):
        """Execute the document analysis operator."""
        ...
        output_field = ctx.params.get("output_field", "vlmrun_document")

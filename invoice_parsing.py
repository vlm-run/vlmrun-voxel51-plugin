"""
Invoice Parsing Operator

Extract structured data from invoice documents using VLM Run.
"""
...
class InvoiceParsingOperator(foo.Operator):
    """Operator for parsing invoice documents using VLM Run."""
    
    @property
    def config(self):
        return foo.OperatorConfig(
            name="invoice_parsing",
            label="VLM Run: Invoice Parsing",
            dynamic=True,
        )
    ...
    def resolve_input(self, ctx):
        ...
        inputs.bool(
            ...
            description="Include bounding box coordinates for extracted fields",
            default=True,
        )
    ...
    def execute(self, ctx):
        """Execute the invoice parsing operator."""
        ...
        output_field = ctx.params.get("output_field", "vlmrun_invoice")
